 ...
 */
//: Drawbacks of OOP
//: 1. When you subclass, you have to inherit properties and methods which you may not need. Your object becomes bloated.
...
class Indian: Humanable {
    var name: String = "Vinoth Vino"
...
struct VinotheDeveloper: SuperHumanable {
    var name: String = "Vinoth"
    var race: String = "Indian"
    func sayHi() {
        print("I code")
    }
